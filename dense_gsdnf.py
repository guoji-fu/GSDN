...
from src import DenseGSDNFConv
...
class Net(torch.nn.Module):
    def __init__(self, 
        ...
        self.alpha = alpha
        self.K = K
        self.conv1 = DenseGSDNFConv(self.in_channels, self.hidden_num, self.alpha, self.K)
        self.conv2 = DenseGSDNFConv(self.hidden_num, self.out_channels, self.alpha, self.K)
